...
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_DUAL_SPEAKER=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_HEADTRACKING_EFFECT=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_SITUATION_EXTENSION=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_TRANSITION_EFFECT=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_VOICE_CHANGER=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_VOICE_TX_FOR_INCALL_MUSIC=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_VOIP_VIA_SMART_VIEW=TRUE
SEC_FLOATING_FEATURE_AUDIO_SUPPORT_VOLUME_MONITOR=DSP
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_HCM_AI_POWER_SAVING_LEVEL=225
